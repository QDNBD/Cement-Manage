...
public class MaterialsConsueBrowseDao {
    ...
    public List<Materials> selectMaterials() {
        ...
        try {
            String sql = "select id,name,type,usestock,stock,unit,create_time from materialuse";
            ...
            System.out.println("原材料出库记录列表：");
            System.out.println(materialsList);

            return materialsList;

        } catch (SQLException e) {
            System.out.println("查询数据库原材料出库数据失败");
            e.printStackTrace();
        }finally {
